...
{
	EvStartStop() {std::cout << "Entered " << __func__ <<std::endl;}
};
struct EvReset : sc::event< EvReset > 
{
	EvReset (){std::cout << "Entered " << __func__<<std::endl;}
};
...
struct Active : sc::simple_state< Active, StopWatch, Stopped >
{
  public:
    ...
    Active() : elapsedTime_( 0.0 ) {std::cout << "Entered " << __func__<<std::endl;}
  ...
  struct Running : IElapsedTime, sc::simple_state< Running, Active >
  {
    public:
      ...
      Running() : startTime_( std::time( 0 ) ) {std::cout << "Entered " << __func__<<std::endl;}
  ...
  struct Stopped : IElapsedTime, sc::simple_state< Stopped, Active >
  {
	...
	Stopped () {std::cout << "Entered " << __func__<<std::endl;}
